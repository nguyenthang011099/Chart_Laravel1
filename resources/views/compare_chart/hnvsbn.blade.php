...
<script>
    ...
    var WindBN=new Array();
    var TemperatureBN=new Array();
    var HumidBN=new Array();
    $(document).ready(function(){
        $.get(url, function(response){
            response.forEach(function(data){
                ...
                WindHY.push(data.WindBN);
                TemperatureHY.push(data.TemperatureBN);
                HumidHY.push(data.HumidBN);
