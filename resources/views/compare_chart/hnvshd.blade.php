...
<script>
    ...
    var WindHD=new Array();
    var TemperatureHD=new Array();
    var HumidHD=new Array();
    $(document).ready(function(){
        $.get(url, function(response){
            response.forEach(function(data){
                ...
                WindHD.push(data.WindHD);
                TemperatureHD.push(data.TemperatureHD);
                HumidHD.push(data.HumidHD);
