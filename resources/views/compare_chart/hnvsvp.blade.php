...
<script>
    ...
    var url = "{{url('charthnvsvp')}}";
    var Years = new Array();
    var Labels = new Array();
    var WindHN = new Array();
    var TemperatureHN= new Array();
    var HumidHN= new Array();
    var WindVP=new Array();
    var TemperatureVP=new Array();
    var HumidVP=new Array();
    $(document).ready(function(){
        $.get(url, function(response){
            response.forEach(function(data){
                ...
                WindVP.push(data.WindVP);
                TemperatureVP.push(data.TemperatureVP);
                HumidVP.push(data.HumidVP);
