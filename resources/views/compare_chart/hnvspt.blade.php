...
<script>
    ...
    var WindPT=new Array();
    var TemperaturePT=new Array();
    var HumidPT=new Array();
    $(document).ready(function(){
        $.get(url, function(response){
            response.forEach(function(data){
                ...
                WindPT.push(data.WindPT);
                TemperaturePT.push(data.TemperaturePT);
                HumidPT.push(data.HumidPT);
