...
<script>
    ...
    var url = "{{url('charthnvshb')}}";
    var Years = new Array();
    var Labels = new Array();
    var WindHN = new Array();
    var TemperatureHN= new Array();
    var HumidHN= new Array();
    var WindHB=new Array();
    var TemperatureHB=new Array();
    var HumidHB=new Array();
    $(document).ready(function(){
        $.get(url, function(response){
            response.forEach(function(data){
                ...
                WindHB.push(data.WindHB);
                TemperatureHB.push(data.TemperatureHB);
                HumidHB.push(data.HumidHB);
